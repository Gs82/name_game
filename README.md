...
- **Players** sign in with Google and enter the class passcode.
- **The organizer** uploads the photo folder, fixes names, sets the dates and prize, changes the passcode, and clears the leaderboard.
